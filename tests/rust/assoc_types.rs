...
#[no_mangle]
pub extern "C" fn test_enum(enum_: EnumTest) {}

#[no_mangle]
pub extern "C" fn test_struct_gen(struct_: AnotherStruct) {}

#[no_mangle]
pub extern "C" fn test_union(union_: UnionTest) {}

#[no_mangle]
pub extern "C" fn test_typedefs(typedef: typedef_test) {}

#[no_mangle]
pub extern "C" fn test_fn(
    struct_: &<MyStruct as MyTrait>::SomeType,
) -> <MyStruct as MyTrait>::SomeType {
    struct_
}

#[no_mangle]
pub extern "C" fn test_func_ptr(
    fn_ptr: extern "C" fn(
        <i32 as AnotherTrait>::AnotherType,
        bool,
    ) -> <i32 as assoc::MyTrait>::SomeType,
) {
}

#[no_mangle]
pub extern "C" fn test_raw_ptr(
    a: *const <i32 as MyTrait>::SomeType,
    b: *mut <i32 as AnotherTrait>::AnotherType,
) {
}
