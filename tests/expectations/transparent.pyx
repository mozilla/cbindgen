...
cdef extern from *:
  ...
  ctypedef enum TransparentEnumWithNoData:
    NoData,
  ...
  ctypedef struct TransparentEmptyStruct:
    pass
  ...
  ctypedef enum TransparentEnumWithEmptyData_Tag:
    EmptyData,

  ctypedef struct EmptyData_Body:
    pass

  ctypedef struct TransparentEnumWithEmptyData:
