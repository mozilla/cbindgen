...
interface Bindings extends Library {
  ...
  @Structure.FieldOrder({"data"})
  class Foo_f32 extends Structure implements Structure.ByValue {
    public Foo_f32() {
      super();
    }
  ...
  @Structure.FieldOrder({"data"})
  class Foo_f32ByReference extends Structure implements Structure.ByReference {
  ...
  @Structure.FieldOrder({"data"})
  class Foo_Bar_f32 extends Structure implements Structure.ByValue {
    public Foo_Bar_f32() {
      super();
    }
  ...
  @Structure.FieldOrder({"data"})
  class Foo_Bar_f32ByReference extends Structure implements Structure.ByReference {
  ...
  class Tuple_Foo_f32_____f32 extends Structure implements Structure.ByValue {
  ...
  @Structure.FieldOrder({"a", "b"})
  class Tuple_Foo_f32_____f32ByReference extends Structure implements Structure.ByReference {
  ...
  @Structure.FieldOrder({"a", "b"})
  class Tuple_f32__f32 extends Structure implements Structure.ByValue {
  ...
  @Structure.FieldOrder({"a", "b"})
  class Tuple_f32__f32ByReference extends Structure implements Structure.ByReference {
