...
cdef extern from *:
  ...
  ctypedef enum EnumTest_Tag:
    enum_var1,
    enum_var2,
    enum_var3,

  ctypedef struct enum_var3_Body:
    bool a;
    uint64_t b;

  ctypedef struct EnumTest:
    EnumTest_Tag tag;
    uint8_t enum_var2[5];
    enum_var3_Body enum_var3;

  ctypedef struct AnotherStruct:
    uint8_t a;
    int64_t b;
    bool c[36];

  ctypedef enum UnionTest_Tag:
    union_var1,
    union_var2,
    union_var3,

  ctypedef struct union_var3_Body:
    bool a;
    uint64_t b;

  ctypedef struct UnionTest:
    UnionTest_Tag tag;
