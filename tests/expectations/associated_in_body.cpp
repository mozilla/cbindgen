...
inline const StyleAlignFlags StyleAlignFlags::AUTO = { /* .bits = */ 0 };
inline const StyleAlignFlags StyleAlignFlags::NORMAL = { /* .bits = */ 1 };
inline const StyleAlignFlags StyleAlignFlags::START = { /* .bits = */ 1 << 1 };
inline const StyleAlignFlags StyleAlignFlags::END = { /* .bits = */ 1 << 2 };
inline const StyleAlignFlags StyleAlignFlags::FLEX_START = { /* .bits = */ 1 << 3 };
