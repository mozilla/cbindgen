...
cdef extern from *:
  ...
  ctypedef struct Foo_i8:
    int8_t x;

  ctypedef struct NotReturnValue_i32:
    int32_t x;

  ctypedef struct FooField:
    Foo_i8 (*f)();
    void (*g)(NotReturnValue_i32);

  ctypedef struct Bar_i16__i16:
    int16_t p;
    int16_t q;

  ctypedef struct Bar_i8__i32:
    int8_t p;
    int32_t q;

  ctypedef Bar_i8__i32 IntBar_i32;

  ctypedef struct Bar_i8__bool:
    int8_t p;
    bool q;
  ...
  ctypedef struct Bar_bool__bool:
    bool p;
    bool q;
  ...
  ctypedef struct Foo_bool:
    bool x;

  ctypedef int8_t WrapNonZeroInt;

  ctypedef struct Foo_i64:
    int64_t x;
