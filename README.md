# `cbindgen` &emsp; [![Build Status]][actions] [![Latest Version]][crates.io] [![Api Rustdoc]][rustdoc] [![Rust](https://img.shields.io/crates/msrv/cbindgen)](https://github.com/mozilla/cbindgen)
